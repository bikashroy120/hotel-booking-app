...
const Sidebar = ({open,setOpen}) => {
  ...
  const menus = [
    { name: "dashboard", link: "/owner", icon: MdOutlineDashboard },
    { name: "user", link: "/owner/user", icon: AiOutlineUser },
    { name: "category", link: "/category", icon: BiCategory },
    { name: "Add Hotel", link: "/owner/add", icon: TbBrandAdonisJs },
    { name: "Hotel", link: "/owner/hotel", icon: GrProductHunt },
